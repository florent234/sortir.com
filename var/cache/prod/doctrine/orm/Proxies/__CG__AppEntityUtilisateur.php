...
class Utilisateur extends \App\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'UserId', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'username', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'telephone', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'password', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'dateCreation', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'administrateur', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'actif', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'campus', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'sorties', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'nomPhoto', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'passwordRequestedAt', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'token'];
        }
    ...
    public function setDateCreation($dateCreation): void
    {
        ...
        parent::setDateCreation($dateCreation);
    }
    ...
    public function getAdministrateur()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdministrateur', []);
    ...
    public function setAdministrateur($administrateur): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAdministrateur', [$administrateur]);

        parent::setAdministrateur($administrateur);
    }
    ...
    public function getNomPhoto()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomPhoto', []);

        return parent::getNomPhoto();
    }
    ...
    public function setNomPhoto($nomPhoto): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomPhoto', [$nomPhoto]);

        parent::setNomPhoto($nomPhoto);
    }
    ...
    public function setSorties($sorties): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSorties', [$sorties]);

        parent::setSorties($sorties);
    }
